...
/**
 * This class demonstrates how to use the Java 11+ HttpClient with Json Schema SERDES to send and receive asynchronous request-reply messages over REST.
 ...
 * </ol>
 * <p>
 * Note: The replying consumer for this sample is the JCSMP sample named JsonSchemaSerdesReplier.
 ...
 * </a>
 */
public class JsonSchemaRestAsyncRequestReply implements AutoCloseable {
     ...
     */
    public JsonSchemaRestAsyncRequestReply(String brokerHost, int publishingPort, int listenPort) throws IOException {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        if (args.length < 4) {
            System.out.printf("Usage: %s <host> <publishing-port> <reply-post-request-target> <listen-port> [<http-topic-header-key>] %n", JsonSchemaRestAsyncRequestReply.class.getName());
            System.exit(-1);
        }
        ...
        try (JsonSchemaRestAsyncRequestReply producer = new JsonSchemaRestAsyncRequestReply(host, portNumber, listenPort)) {
    ...
    public void startReplyServer(Deserializer<CreateUserResponse> deserializer, String replyPath, String httpTopicHeaderKey) {
     ...
     */
    public void publishRequest(Serializer<CreateUser> serializer, String requestTopic) throws IOException, InterruptedException {
    ...
    static class SerdesMessageHandler implements HttpHandler {
        ...
        final Deserializer<CreateUserResponse> deserializer;
        final Function<CreateUserResponse, String> objectToStringFunc;
         ...
         */
        public SerdesMessageHandler(Deserializer<CreateUserResponse> deserializer, Function<CreateUserResponse, String> objectToString, String httpTopicHeaderKey) {
        ...
        public void handleSerdesMessage(HttpExchange exchange) throws IOException {
            ...
            CreateUserResponse object = deserializer.deserialize(requestTopic.orElse(""), messagePayload, serdesHeaders);
